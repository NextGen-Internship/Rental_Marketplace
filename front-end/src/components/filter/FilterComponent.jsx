...
const FilterComponent = ({ notShowDropdown,categoryId  ,onFilterChange} ) => {
  ...
  const applyFilters = async (e) => {
    ...
    try {
      ...
      const apiUrl = `http://localhost:8080/rentify/items/filter?category=${filters.category}&priceFrom=${filters.priceFrom 
      || ''}&priceTo=${filters.priceTo || ''}&address=${filters.address}&searchTerm=${filters.name}`;
...
<div className="col-12">
  <div className="input-group">
    ...
    <input type="text" className="form-control" id="inlineFormInputGroupUsername" placeholder="Search by name"
     value={searchTerm}
...
<div className="col-12">
  ...
  <div className="input-group">
    ...
    <input type="number" className="form-control" id="inlineFormInputGroupUsername" placeholder="Price From"
    value={priceFrom}
...
<div className="col-12">
  <div className="input-group">
    <div className="input-group-text"><SearchIcon className="search-icon" /></div>
    <input className="text" class="form-control" id="inlineFormInputGroupUsername" placeholder="Search by name"
     value={searchTerm}
             onChange={handleSearchChange}
              onKeyPress={handleKeyPress}
    />
